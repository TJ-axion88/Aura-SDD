...
const CONTAMINATION_PATTERNS = [
  { pattern: /\/home\/msub88/,              label: '開発者ホームパス (/home/msub88)' },
  { pattern: /\/Users\/msub88/,             label: '開発者ホームパス (/Users/msub88)' },
  { pattern: /\bmsub88\b/,                  label: '開発者ユーザー名 (msub88)' },
  { pattern: /axionsoft88@users\.noreply/,  label: '開発者プライベートコミットメール' },
  { pattern: /n95455555/,                   label: '開発者個人メールアドレスの識別子' },
