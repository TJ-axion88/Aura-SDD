...
const CONTAMINATION_PATTERNS: Array<{ pattern: RegExp; label: string }> = [
  { pattern: /\/home\/msub88/,             label: 'dev home path (/home/msub88)' },
  { pattern: /\/Users\/msub88/,            label: 'dev home path (/Users/msub88)' },
  { pattern: /\bmsub88\b/,                 label: 'dev username (msub88)' },
  { pattern: /axionsoft88@users\.noreply/, label: 'dev commit email' },
  { pattern: /n95455555/,                  label: 'dev personal email identifier' },
