...
This project uses **Aura-SDD v3.0** — a Spec-Driven Development framework with Boundary-First discipline, Constitutional Enforcement, and autonomous implementation.
