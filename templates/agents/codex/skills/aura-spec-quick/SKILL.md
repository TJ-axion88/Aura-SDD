---
name: aura-spec-quick
description: Fast-track spec creation. Combines requirements + design + tasks in one shot, skipping the separate plan phase. Best for small-to-medium features.
---
