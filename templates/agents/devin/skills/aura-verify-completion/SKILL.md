---
name: aura-verify-completion
description: Fresh-evidence gate before claiming a task or feature is done. Reads actual files and runs checks — never trusts prior claims of success.
---
