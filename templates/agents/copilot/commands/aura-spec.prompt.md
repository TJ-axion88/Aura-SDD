---
name: aura-spec
description: "Aura-SDD: Create a feature specification with EARS-format requirements and user scenarios. Phase 1 of the pipeline."
mode: agent
---
...
Feature name: argument provided inline, or read from `.aura/discovery/brief.md` if it exists.

1. **Load context** — read (skip if absent): `.aura/constitution.md`, `.aura/steering/*.md`, `.aura/discovery/brief.md`, relevant existing code files.
...
5. **Generate spec.md** using this structure:
   ...
   ## Introduction
   <One paragraph: what, for whom, and why it matters>
...
6. **Human approval gate** — present spec.md and ask:
